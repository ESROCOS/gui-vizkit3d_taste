...
cd "$SKELS" && rm -f vizkit3d_rigidbodystate.zip && zip vizkit3d_rigidbodystate vizkit3d_rigidbodystate/* && cd $OLDPWD

cd "$SKELS" && rm -f test_bodystate.zip && zip test_bodystate test_bodystate/* && cd $OLDPWD

cd "$SKELS" && rm -f vizkit3d_bodystate.zip && zip vizkit3d_bodystate vizkit3d_bodystate/* && cd $OLDPWD
