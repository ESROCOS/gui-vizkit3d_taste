...
cd "$SKELS" && rm -f vizkit3d_trajectory.zip && zip vizkit3d_trajectory vizkit3d_trajectory/* && cd $OLDPWD

cd "$SKELS" && rm -f vizkit3d_waypoint.zip && zip vizkit3d_waypoint vizkit3d_waypoint/* && cd $OLDPWD

cd "$SKELS" && rm -f vizkit3d_motioncommand.zip && zip vizkit3d_motioncommand vizkit3d_motioncommand/* && cd $OLDPWD
